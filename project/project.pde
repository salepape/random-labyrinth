...
void draw(){
    ...
    switch (k){
        case 0 : 
           // MENU PRINCIPAL //
           noStroke();
           e = loadImage("../data/panneaumenu.png");
           e6 = loadImage("../data/fond2.jpg");
           e6.resize(866,693);
           background(e);
           nivdiff();
           campagne = 0;
       ...
       case 1 :
           switch (r){      
               case 1:
                   e1 = loadImage("../data/bombe.png");
                   e2 = loadImage("../data/coeur.png");
                   e3 = loadImage("../data/crabe_fermee.png");
                   e4 = loadImage("../data/crabe_ouverte.png");
                   f = loadImage("../data/personnage laby.png"); 
                   g = loadImage("../data/sable.png");
                   h = loadImage("../data/eau.png");
               break;      
               case 2 :
                   e1 = loadImage("../data/bombe.png");
                   e2 = loadImage("../data/coeur.png");
                   e3 = loadImage("../data/croco_fermee.png");
                   e4 = loadImage("../data/croco_ouverte.png");
                   f = loadImage("../data/personnage laby.png"); 
                   g = loadImage("../data/herbenoire2.png");
                   h = loadImage("../data/marais.png");
               break;    
               case 3 :
                   e1 = loadImage("../data/bombe.png");
                   e2 = loadImage("../data/coeur.png");
                   e3 = loadImage("../data/dalles.png");
                   e4 = loadImage("../data/bombe2.png");
                   f = loadImage("../data/personnage laby.png"); 
                   g = loadImage("../data/dalles.png");
                   h = loadImage("../data/grattesciel.png");
               break;      
               case 4 :
                   e1 = loadImage("../data/bombe.png");
                   e2 = loadImage("../data/coeur.png");
                   e3 = loadImage("../data/terrevol.png");
                   e4 = loadImage("../data/flamme.png");
                   f = loadImage("../data/personnage laby.png"); 
                   g = loadImage("../data/terrevol.png");
                   h = loadImage("../data/lave.png");
               break;     
               case 5 :
                   e1 = loadImage("../data/bombe.png");
                   e2 = loadImage("../data/coeur.png");                                                         
                   e3 = loadImage("../data/egouts.png");
                   e4 = loadImage("../data/egouts2.png");
                   f = loadImage("../data/personnage laby.png"); 
                   g = loadImage("../data/bitume.png");
                   h = loadImage("../data/mur.png");
               break;      
               case 6 :
                   e1 = loadImage("../data/bombe.png");
                   e2 = loadImage("../data/coeur.png");
                   e3 = loadImage("../data/plantefermee.png");
                   e4 = loadImage("../data/plante.png");
                   f = loadImage("../data/personnage laby.png"); 
                   g = loadImage("../data/terre.png");
                   h = loadImage("../data/foret.png");
               break;     
               case 7 :
                   e1 = loadImage("../data/bombe.png");
                   e2 = loadImage("../data/coeur.png");
                   e3 = loadImage("../data/neige.png");
                   e4 = loadImage("../data/stalagmites.png");
                   f = loadImage("../data/personnage laby.png"); 
                   g = loadImage("../data/neige.png");
                   h = loadImage("../data/montagnes.png");
               break;     
               case 8 :
                   e1 = loadImage("../data/bombe.png");
                   e2 = loadImage("../data/coeur.png");
                   e3 = loadImage("../data/cactus3.png");
                   e4 = loadImage("../data/cactus2.png");
                   f = loadImage("../data/personnage laby.png"); 
                   g = loadImage("../data/craquele.png");
                   h = loadImage("../data/desert.png");
               break;
                        }
           e1.resize(a,a);
           e2.resize(a,a);
        ...
        for ( y = 0 ; y < dim; y = y + a){
            ...
            xp = x/a;
                switch (tab[xp][yp]){   
                    ...
                    break;
                    case 30: // pt arrivée //
                        e5 = loadImage("../data/portesortie.png");
                        image(e5,x,y,a,a);
                    break;
                                    }
                                         }
